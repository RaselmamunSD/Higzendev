      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <h3 className="text-xl md:text-2xl font-semibold mb-4 text-white">Global IT Solutions Provider</h3>
            <p className="mb-6 text-gray-300">
              TechWave is a trusted global provider of IT solutions and services, including web design 
            ...
            <h3 className="text-xl md:text-2xl font-semibold mb-4 text-white">Diverse Clientele</h3>
            <p className="mb-6 text-gray-300">
